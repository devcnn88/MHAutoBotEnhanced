...
function bwRift(){
	...
	var objDefaultBWRift = {
		...
		specialActivate : {
			...
			forceDeactivate : new Array(16).fill(false),
			remainingLootDeactivate : new Array(16).fill(1)
		},
		gw : {
