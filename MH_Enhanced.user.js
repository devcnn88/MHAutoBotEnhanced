...
var objBestTrap = {
	weapon : {
		arcane : ['Intergalactic Isolinear Positioning Chips','Event Horizon','Grand Arcanum Trap','Chrome Arcane Capturing Rod','Arcane Blast Trap','Arcane Capturing Rod Of Nev'],
...
function labyrinth() {
	...
	if(isAtHallway){
		...
		if(strCurHallwayFullname.indexOf('FARMING') > -1)
			checkThenArm('best', 'weapon', ['Intergalactic Isolinear Positioning Chips','Event Horizon'].concat(objBestTrap.weapon.forgotten));
		else
			checkThenArm('best', 'weapon', objBestTrap.weapon.forgotten);
